...
public class VoteController {
    ...
    public ResponseEntity<Response> createVote(Long blogId) {
        ...
        try {
            ...
            List<Vote> votes = blog.getVotes();
             currentVote = votes.get(votes.size()-1);
            System.out.println("currentVote:" + currentVote);
        ...
        return ResponseEntity.ok().body(new Response(true, "点赞成功", currentVote));
    }
    ...
    public ResponseEntity<Response> delete(@PathVariable("id") Long id, Long blogId) {
        ...
        User user = voteService.getVoteById(id).get().getUser();
