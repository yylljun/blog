...
public class UserspaceController {
    ...
    public String getBlogById(@PathVariable("username") String username, @PathVariable("id") Long id, Model model) {
        ...
        similarest = esBlogService.listSimilarEsBlogs(QueryParser.escape(blog.getTitle().replace(" ","")), QueryParser.escape(blog.getTags().replace(" ","")));
        model.addAttribute("similarest", similarest);
...
//        model.addAttribute("catalogs", catalogs);
    ...
    public ResponseEntity<Response> saveBlog(@PathVariable("username") String username,
        ...
        try {
            ...
            if (blog.getId() != null) {
                ...
                System.out.println("optionalBlog:" + blog.getTags());
                if (optionalBlog.isPresent()) {
                    System.out.println("编辑修改博客............");
    ...
    public ResponseEntity<Response> saveAvatar(@PathVariable("username") String username, @RequestBody User user) {
        ...
        User originalUser = userService.getUserById(user.getId()).get();
        String old_avater = originalUser.getAvatar();
        originalUser.setAvatar(avatarUrl);
        userService.saveOrUpateUser(originalUser);

        return ResponseEntity.ok().body(new Response(true, "处理成功", old_avater));
    }
