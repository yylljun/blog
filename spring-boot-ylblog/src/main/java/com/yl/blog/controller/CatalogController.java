...
import com.yl.blog.vo.CatalogVO;
...
//    @ResponseBody
    @GetMapping
    public String listComments(@RequestParam(value = "username", required = true) String username,
                               @RequestParam(value = "isblogedit") boolean isblogedit, Model model) {
